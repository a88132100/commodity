...
const products = [
    ...
    },
    {
        id: 44,
        name: '古早味蒜片豆干',
        description: '選用非基改黃豆製成，拌入蒜香滷汁慢火滷製，口感紮實入味，蒜香與豆香相得益彰。',
    ...
    },
    {
        id: 48,
        name: '嚴選新社香菇',
        description: '來自台中市新社區的山林香菇，由在地農戶自然栽培、低溫乾燥製成，保留香菇完整風味與營養成分。香氣濃郁，口感厚實，泡發後依然飽滿多汁，是料理、燉湯、滷味不可或缺的好味道。',
        image: 'images/52035_0.jpg',
        mainCategory: '其他',
        subCategory: '其他',  // 添加小分類
        weight: '300g',         // 添加重量信息
        price: 600,             // 添加價格信息
